...
function App() {
    ...
    useEffect(() => {
        axios.get("/api/home").then((res) => setAuth(res.data));
    ...
    return (
        <Router>
            ...
            <Route
                path="/qr-scanner"
                exact
                render={(props) => <QRScanner {...GLOBAL_STATE} />}
            />
            <Route
                path="/parking-scanner"
                exact
                render={(props) => <ParkingScanner {...GLOBAL_STATE} />}
            />
            <Route
                path="/pay"
                exact
                render={(props) => <Pay {...GLOBAL_STATE} />}
            />
            <Route
                path="/history"
                exact
                render={(props) => <History {...GLOBAL_STATE} />}
            />
